<template>
    <div class="contact">
        <h1 class="w3layouts">Ravishing Contact Form</h1>
        ...
        <p class="copyright-agileits">© 2019 Ravishing Contact Form. All Rights Reserved | Design by <a href="#">xiaoyun</a></p>
    </div>
</template>
<script>
export default {
...
input#username:focus,input#email:focus,textarea#message:focus {
